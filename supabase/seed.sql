...
set
  ...
  program_names = array['Beacon/ Anchor', 'Bayside']::text[],
...
set
  ...
  program_names = array['Outpatient Services']::text[],
...
values
  ...
  (
    ...
    'Beacon/ Anchor morning pickup',
    'Approved shift picked up by Jamie for Beacon/ Anchor coverage.',
    'Beacon/ Anchor',
    'Toms River',
  ...
  (
    ...
    'Beacon/ Anchor afternoon pickup',
    'Second approved shift picked up by Jamie for Beacon/ Anchor coverage.',
    'Beacon/ Anchor',
    'Toms River',
    current_date + interval '2 days',
    '12:00',
