...
const workerProfiles: WorkerProfile[] = [
  {
    ...
    status: "approved",
    program_name: "Anchor",
    program_names: ["Anchor", "Beacon", "Bayside"],
...
const shifts: ShiftPost[] = [
  ...
  },
  {
    ...
    program_name: "Code Red/Code Blue",
  ...
  {
    id: "shift-6",
    title: "Anchor morning pickup",
    details: "Approved shift picked up by Jamie for Anchor coverage.",
    program_name: "Anchor",
    location_name: "Toms River",
  ...
  {
    id: "shift-7",
    title: "Anchor afternoon pickup",
    details: "Second approved shift picked up by Jamie for Anchor coverage.",
    program_name: "Anchor",
    location_name: "Toms River",
    shift_date: dateFromToday(2),
    start_time: "12:00",
